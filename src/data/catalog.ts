...
export const heroSlides: HeroSlide[] = [
  ...
  {
    title: "The Medium: A Herdeira",
    year: "2021",
    genre: "Terror Shamanista Asiático",
    tagline: "Uma possessão aterrorizante nas florestas sagradas da Tailândia.",
    backdrop: "/8DHvtmF15wGwkMOW3nqZmpEzEaq.jpg",
    poster: "/vgONeDoY02WPjCw4ApDaPohxqrv.jpg",
    objectPosition: "center 20%",
