...
export const heroSlides: HeroSlide[] = [
  ...
  {
    title: "Exhuma: O Mal Que Nos Habita",
    year: "2024",
    genre: "Terror / Sobrenatural Coreano",
    tagline: "Uma tumba profanada desperta uma maldição ancestral sem precedentes.",
    backdrop: "/gn2p48VMKOP4TzEKrhY2EU3E47P.jpg",
    poster: "/5SkDwxtkvrNYahgQ6Xp0YJDlWw6.jpg",
    objectPosition: "center 25%",
    objectPositionMobile: "60% 15%",
    brightness: "brightness(1.15)",
  },
  {
    title: "Undertone",
