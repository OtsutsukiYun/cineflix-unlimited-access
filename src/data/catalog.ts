...
export const heroSlides: HeroSlide[] = [
  ...
  {
    title: "Missa da Meia-Noite (Midnight Mass)",
    year: "Série",
    genre: "Série de Terror Sobrenatural",
    tagline: "Milagres gloriosos e mistérios sombrios assombram uma ilha isolada.",
    backdrop: "/YauN3gyvgqktYhze4gXPWuoZBY.jpg",
    poster: "/3eVSQJdiBin6A7F7nsg62eJFf0Y.jpg",
    objectPosition: "center 20%",
