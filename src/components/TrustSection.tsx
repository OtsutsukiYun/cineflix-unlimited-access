...
export function TrustSection() {
  return (
    <section className="mx-auto w-[94%] max-w-6xl py-14">
          ...
          <div className="glass h-full rounded-4xl p-8">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div
                  key={s.t}
                  className="flex flex-col items-center gap-1.5 rounded-2xl border border-border bg-surface px-3 py-5 text-center"
                >
