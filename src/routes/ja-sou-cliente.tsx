...
const WHATSAPP_SUPPORT_URL = "https://wa.me/556182743140?text=Ol%C3%A1!%20Comprei%20minha%20recarga%20e%20quero%20meu%20acesso%2C%20tenho%20d%C3%BAvidas%20ou%20preciso%20de%20reembolso";
        ...
        <div className="rounded-3xl border border-emerald-500/40 bg-gradient-to-b from-emerald-950/80 via-zinc-900 to-zinc-950 p-6 sm:p-8 text-center space-y-4 backdrop-blur-2xl shadow-[0_15px_50px_rgba(16,185,129,0.2)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              ...
              <span>💬 QUERO MEU ACESSO, RECARGA E REEMBOLSO</span>
            </a>
          </div>
        </div>
