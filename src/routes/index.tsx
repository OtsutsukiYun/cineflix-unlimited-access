...
function Index() {
  ...
  return (
    <div className="relative w-full overflow-x-hidden min-h-screen bg-[#080808] font-sans text-foreground antialiased selection:bg-red-600 selection:text-white">
      ...
      {/* ATUALIZAÇÕES CONSTANTES — LANÇAMENTOS DE CINEMA, SÉRIES E ANIMES */}
      <section id="atualizacoes" className="relative z-10 mx-auto w-[94%] max-w-6xl py-6 sm:py-10 scroll-mt-28">
        <SmoothCardReveal>
          <div className="text-center mb-5 sm:mb-7">
            <span className="inline-flex items-center gap-2 rounded-full border border-amber-500/40 bg-amber-950/40 px-4 py-2 text-xs font-extrabold tracking-wider text-amber-300 uppercase mb-3">
              <RefreshCcw className="size-3.5" /> Atualizações constantes
            </span>
            <h2 className="text-2xl sm:text-4xl font-black tracking-tight text-white max-w-2xl mx-auto">
              Novos lançamentos de cinema, séries e animes <span className="text-amber-400">toda semana</span>
            </h2>
            <p className="mt-2 text-sm text-white/60 max-w-xl mx-auto">
              O catálogo nunca para. Recebemos estreias quentinhas do cinema, episódios inéditos de séries e os animes da temporada assim que saem — você assiste antes de todo mundo.
            </p>
          </div>
        </SmoothCardReveal>
        ...
        <div className="grid gap-4 sm:gap-5 sm:grid-cols-3">
          ...
          <SmoothCardReveal delay={120}>
            <div className="glass group relative h-full overflow-hidden rounded-3xl border border-amber-500/40 bg-zinc-950/60 p-6 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(245,158,11,0.45)]">
              <div className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 via-orange-600 to-red-600 shadow-[0_0_22px_rgba(245,158,11,0.85)] transition-transform duration-300 group-hover:scale-110">
                <Film className="size-7 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]" />
              </div>
              <h3 className="mb-1.5 text-lg font-black text-white tracking-tight">Lançamentos de cinema</h3>
              <p className="text-sm leading-relaxed text-white/70 font-medium">
                Filmes recém-saídos das salas de cinema chegando primeiro no UniTV PRO, em alta definição com áudio original.
              </p>
              <div className="mt-4 flex items-center gap-2 text-xs font-bold text-amber-300">
                <span className="flex size-2 rounded-full bg-amber-400 animate-pulse" /> Adicionado esta semana
              </div>
            </div>
          </SmoothCardReveal>
          ...
          <SmoothCardReveal delay={200}>
            <div className="glass group relative h-full overflow-hidden rounded-3xl border border-red-500/40 bg-zinc-950/60 p-6 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(239,68,68,0.45)]">
              <div className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-red-600 via-rose-600 to-red-800 shadow-[0_0_22px_rgba(239,68,68,0.85)] transition-transform duration-300 group-hover:scale-110">
                <Tv className="size-7 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]" />
              </div>
              <h3 className="mb-1.5 text-lg font-black text-white tracking-tight">Séries inéditas</h3>
              <p className="text-sm leading-relaxed text-white/70 font-medium">
                Episódios novos das maiores séries do mundo assim que estreiam, com temporadas completas dubladas e legendadas.
              </p>
              <div className="mt-4 flex items-center gap-2 text-xs font-bold text-red-300">
                <span className="flex size-2 rounded-full bg-red-400 animate-pulse" /> Atualização semanal
              </div>
            </div>
          </SmoothCardReveal>

          {/* Animes */}
          <SmoothCardReveal delay={280}>
            <div className="glass group relative h-full overflow-hidden rounded-3xl border border-orange-500/40 bg-zinc-950/60 p-6 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(249,115,22,0.45)]">
              <div className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 via-amber-600 to-yellow-600 shadow-[0_0_22px_rgba(249,115,22,0.85)] transition-transform duration-300 group-hover:scale-110">
                <Flame className="size-7 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]" />
              </div>
              <h3 className="mb-1.5 text-lg font-black text-white tracking-tight">Animes da temporada</h3>
              <p className="text-sm leading-relaxed text-white/70 font-medium">
                Simulcast semanal dos animes mais bombados da temporada, com dublagem em português e episódios logo após o Japão.
              </p>
              <div className="mt-4 flex items-center gap-2 text-xs font-bold text-orange-300">
                <span className="flex size-2 rounded-full bg-orange-400 animate-pulse" /> Novos episódios a cada semana
              </div>
            </div>
          </SmoothCardReveal>
        </div>
        ...
        {/* Faixa de destaque */}
        <SmoothCardReveal delay={360}>
          <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 rounded-2xl border border-white/10 bg-gradient-to-r from-zinc-900/80 via-zinc-900/60 to-zinc-900/80 px-5 py-4 text-center backdrop-blur-xl">
            <Zap className="size-6 text-amber-400 shrink-0" />
            <p className="text-sm sm:text-base font-bold text-white">
              Mais de <span className="text-amber-400">60.000 títulos</span> atualizados constantemente — sempre tem algo novo para assistir.
            </p>
          </div>
        </SmoothCardReveal>
      </section>
