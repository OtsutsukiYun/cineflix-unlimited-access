    ...
    <div className="relative w-full overflow-x-hidden min-h-screen bg-[#080808] font-sans text-foreground antialiased selection:bg-red-600 selection:text-white">
      ...
      <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden text-center">
        ...
        <div className="relative z-10 mx-auto w-[94%] max-w-3xl pt-44 pb-10 sm:pt-56 sm:pb-14 text-center">
          ...
          {/* SUBTÍTULO */}
          <p className="text-[13px] sm:text-base font-medium text-white/80 w-[96%] sm:w-full max-w-2xl mx-auto px-3 sm:px-0 leading-relaxed text-balance drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
            Doramas, animes, novelas turcas, canais ao vivo e muito mais para assistir nos seus dispositivos Android (Smart TV Android, TV Box, smartphone Android, tablet ou projetor).
          </p>
