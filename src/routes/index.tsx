...
const CATALOG_TABS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Liar Game", poster: "/w8yyntTxZlDlZ2TR8kb4C92pmcO.jpg", year: "2026", tag: "🔥 Anime 2026" },
...
function AnimatedHeroHeadline() {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 place-items-center w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto mb-1.5 sm:mb-2">
      ...
      {/* FRASE 2: Um catálogo muito mais completo, com conteúdos que você não encontra em outros streamings. */}
      <h1
...
function Index() {
  ...
  return (
    <div className="relative w-full overflow-x-hidden min-h-screen bg-[#080808] font-sans text-foreground antialiased selection:bg-red-600 selection:text-white">
          ...
          {[
            {
              ...
              badgeStyle: "bg-orange-500/25 text-orange-200 border-orange-500/50 shadow-[0_0_15px_rgba(249,115,22,0.4)]",
              cardStyle: "border border-orange-500/40 bg-gradient-to-b from-orange-950/50 via-zinc-900/95 to-zinc-950 shadow-[0_0_40px_rgba(249,115,22,0.25)] hover:border-orange-500/70 hover:shadow-[0_0_50px_rgba(249,115,22,0.4)]",
              btnStyle: "bg-gradient-to-r from-orange-600 via-amber-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white font-black py-4 px-4 rounded-2xl shadow-[0_0_30px_rgba(234,88,12,0.6)] hover:scale-[1.03] border border-orange-400/60 text-sm sm:text-base transition-all",
            ...
            },
            {
              ...
              icon: Crown,
              iconColor: "text-amber-400 drop-shadow-[0_0_18px_rgba(245,158,11,1)]",
              titleGradient: "text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-orange-300 to-amber-400 font-black",
              precoAntigo: "R$250",
              preco: "R$179,99",
              periodo: "ano",
              dias: "365 dias",
              ...
              badgeStyle: "bg-gradient-to-r from-amber-500/40 to-orange-500/40 text-amber-200 border-amber-400/70 shadow-[0_0_20px_rgba(245,158,11,0.5)] font-black",
              ...
              btnStyle: "bg-gradient-to-r from-orange-500 via-amber-500 to-red-600 hover:from-orange-400 hover:to-red-500 text-white font-black py-4 px-4 rounded-2xl shadow-[0_0_35px_rgba(245,158,11,0.9)] hover:scale-[1.04] border border-orange-300 text-sm sm:text-base transition-all",
            ...
            },
            {
              ...
              icon: Sparkles,
              iconColor: "text-orange-400 drop-shadow-[0_0_12px_rgba(249,115,22,0.8)]",
              titleGradient: "text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-100 to-orange-300 font-black",
              precoAntigo: "R$149",
              preco: "R$99,99",
              periodo: "3 meses",
              dias: "90 dias",
      ...
      <section id="suporte" className="relative z-10 border-t border-white/5 bg-black/30 py-12 scroll-mt-24">
        <div className="mx-auto w-[94%] max-w-2xl text-center">
          ...
          <p className="text-xs sm:text-sm text-white/60 mb-6 max-w-md mx-auto leading-relaxed">
            Fale com a nossa equipe no WhatsApp para instalação, recargas, dúvidas sobre seu acesso ou reembolso! Atendimento 7 dias por semana.
          </p>
      ...
      <Reveal>
        <section className="relative z-10 border-t border-white/10 bg-white/[0.02] py-6 sm:py-12 backdrop-blur-md">
          <div className="mx-auto w-[94%] max-w-5xl">
            <div className="text-center mb-4 sm:mb-8">
              ...
              <h3 className="mt-1.5 sm:mt-3 text-sm sm:text-2xl font-black text-white">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3.5 sm:grid-cols-3 lg:grid-cols-6">
              {[
                ...
                <div
                  key={c.title}
                  className="group relative flex flex-col items-center justify-center text-center gap-1 rounded-xl sm:rounded-2xl border border-white/10 bg-white/[0.04] p-2.5 sm:p-4 text-center backdrop-blur-xl transition-all duration-300 hover:border-white/25 hover:bg-white/[0.08] hover:-translate-y-1 shadow-md"
                >
                  <div className={`flex size-7 sm:size-11 shrink-0 items-center justify-center rounded-lg sm:rounded-xl bg-white/[0.06] border border-white/10 ${c.color} shadow-inner transition-transform group-hover:scale-110 mb-0.5`}>
                    <c.icon className="size-3.5 sm:size-5" />
                  </div>
