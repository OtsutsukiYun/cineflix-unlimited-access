...
const CATALOG_TABS = [
  {
    ...
    items: [
      ...
      { title: "Acampamento Miasma", poster: "/5Cz1EJOKpZ8hqvBNZYF9C2zTB2T.jpg", year: "2026", tag: "🔥 Terror 2026" },
      { title: "O Sorveteiro", poster: "/c987gxFjXqYOxZEZKcTkS1ONTWH.jpg", year: "2026", tag: "🔥 Terror 2026" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Acampamento Miasma", poster: "/5Cz1EJOKpZ8hqvBNZYF9C2zTB2T.jpg", year: "2026", tag: "🔥 Terror 2026" },
      { title: "O Sorveteiro", poster: "/c987gxFjXqYOxZEZKcTkS1ONTWH.jpg", year: "2026", tag: "🔥 Terror 2026" },
      { title: "O Último Tiro Certo", poster: "/niQ4NBh2jqAf1hDZP5m6ReWFAb7.jpg", year: "2026", tag: "🔥 Ação 2026" },
      { title: "Obsessão", poster: "/wUc6IDf5ChjM1UyQye21qFBeJY0.jpg", year: "2026", tag: "🔥 Top 1" },
...
function AnimatedHeroHeadline() {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 place-items-center w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto mb-1.5 sm:mb-2">
      ...
      {/* FRASE 2: Um aplicativo muito mais completo, com conteúdos que você não encontra em outros streamings. */}
      <h1
      ...
      >
        <span>
          Um aplicativo muito mais completo, com conteúdos que você <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent">não encontra em outros streamings.</span>
        </span>
      </h1>
    ...
    <div className="relative w-full overflow-x-hidden min-h-screen bg-[#080808] font-sans text-foreground antialiased selection:bg-red-600 selection:text-white">
      ...
      <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden text-center">
        ...
        <div className="relative z-10 mx-auto w-[94%] max-w-3xl pt-44 pb-10 sm:pt-56 sm:pb-14 text-center">
          ...
          {/* SUBTÍTULO */}
          <p className="text-sm sm:text-base font-medium text-white/80 max-w-xl mx-auto px-2 leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] [text-wrap:balance]">
            O maior catálogo de conteúdos, com filmes, séries, canais ao vivo, doramas, animes e novelas turcas para assistir nos seus <span className="whitespace-nowrap">dispositivos Android.</span>
          </p>
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-white/90 font-medium drop-shadow-[0_2px_8px_rgba(0,0,0,1)]">
            <span className="flex items-center gap-1.5"><Sparkles className="size-4 text-red-500" /> Mais conteúdos que os outros aplicativos</span>
      ...
      <section id="planos" className="relative z-10 mx-auto w-[94%] max-w-6xl py-6 sm:py-8">
        ...
        <Reveal className="relative z-10 text-center mb-4 sm:mb-6">
          ...
          <h2 className="text-3xl font-black sm:text-5xl tracking-tight text-white mb-2 max-w-2xl mx-auto [text-wrap:balance]">
          ...
          {[
            {
              ...
              features: [
                ...
                "Compatível com Smart TV Android, TV Box, Stick, Celular Android, Tablet e Projetor",
