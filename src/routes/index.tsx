      ...
      <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden text-center">
        ...
        <div className="relative z-10 mx-auto w-[94%] max-w-3xl pt-28 pb-10 sm:pt-32 sm:pb-12 text-center">
          ...
          <p className="mt-3 text-xs sm:text-base text-white/90 max-w-[340px] sm:max-w-xl mx-auto leading-snug sm:leading-relaxed">
            Assista a produções de terror exclusivas, esportes ao vivo e canais em até 4K na sua TV, celular, tablet ou projetor.
          </p>
          ...
          {[
            {
              ...
              cardStyle: "border border-white/15 bg-gradient-to-b from-red-950/20 via-zinc-950/90 to-black hover:border-red-500/50 shadow-[0_0_30px_rgba(239,68,68,0.15)] hover:shadow-[0_0_40px_rgba(239,68,68,0.3)]",
              btnStyle: "bg-gradient-to-r from-red-600 via-red-700 to-rose-700 hover:from-red-500 hover:to-rose-600 text-white font-black py-3.5 px-4 rounded-xl shadow-[0_0_25px_rgba(220,38,38,0.5)] hover:scale-[1.02] border border-red-500/50 transition-all",
              ...
              features: [
                ...
                "Smart TV Android, TV Box, Mi Stick, FireTV, Projetor",
            ...
            },
            {
              ...
              features: [
                ...
                "Títulos que não estão nos streamings tradicionais",
                "Todos os canais ao vivo e esportes em alta definição",
                "Smart TV Android, TV Box, Mi Stick, FireTV, Projetor",
                "Celular Android e Tablet Android",
                "Suporte 7 dias via WhatsApp",
                "Garantia de reembolso de 7 dias",
